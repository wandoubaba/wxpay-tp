...
require_once 'WxPayDataBaseSignMd5.php';
require_once 'WxPayResults.php';
require_once 'WxPayNotify.php';
require_once 'WxPayNotifyResults.php';
require_once 'WxPayNotifyReply.php';
require_once 'WxPayUnifiedOrder.php';
require_once 'WxPayOrderQuery.php';
require_once 'WxPayCloseOrder.php';
require_once 'WxPayRefund.php';
require_once 'WxPayRefundQuery.php';
require_once 'WxPayDownloadBill.php';
require_once 'WxPayReport.php';
require_once 'WxPayShortUrl.php';
require_once 'WxPayMicroPay.php';
require_once 'WxPayReverse.php';
require_once 'WxPayJsApiPay.php';
require_once 'WxPayBizPayUrl.php';
